...
@section('content')
    <form action="{{route('articol.update',$articol->id)}}" method="post">
        @csrf
        @method('patch')
        <div class="form-group">
            <label for="art_nummer">Art Nummer</label>
            <input type="text" class="form-control" id="art_nummer" name="art_nummer" placeholder="Articol nummar" value="{{$articol->art_nummer}}">
        </div>
